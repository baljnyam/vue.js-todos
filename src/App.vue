  ...
  <div class="app">
    <div class="container">
      <div class="row header">
        <h1 class="col s6 offset-s3 center-align black-text"></h1>
      </div>
      <div class="row">
        <form @submit.prevent="submitTodo" class="col s6 offset-s3">
          <div class="input-field">
            ...
            <label for="icon_prefix2">list</label>
          </div>
          <button class="btn waves-effect col s12 red">Add</button>
        </form>
      </div>
      <div class="row">
              ...
              <label>
                ...
                <span>
                  <a @click.prevent="deleteTodo(todo)">
                    <i class="material-icons right teal-text">remove</i>
                  </a>
                </span>
              </label>
            </p>
